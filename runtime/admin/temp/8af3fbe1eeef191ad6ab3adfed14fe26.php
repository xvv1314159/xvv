<?php /*a:2:{s:54:"/www/wwwroot/www.xvv.cc/app/admin/view/rule/index.html";i:1773769974;s:48:"/www/wwwroot/www.xvv.cc/app/admin/view/base.html";i:1773769974;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
...
<div class="row">
  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-body">
        <div class="card-btns mb-2-5 d-flex justify-content-between">
          <div>
            <a class="btn btn-sm btn-primary me-1" href="add<?php echo !empty($pluginId) ? '?plugin='.$pluginId.($iframe ? '&iframe=1'  :  '') : ($iframe ? '?iframe=1' : ''); ?>"><i class="mdi mdi-plus"></i> 新增</a>
          </div>
        </div>
        <div class="table-responsive">
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                <td><?php echo htmlentities((string) $v['id']); ?></td>
                <td><?php echo htmlentities((string) $v['title']); ?></td>
                <td><?php echo htmlentities((string) $v['href']); ?></td>
                <td><?php echo htmlentities((string) $v['sort']); ?></td>
                <td><?php echo !empty($v['is_menu']) ? '显示' : '隐藏'; ?></td>
                <td><?php echo !empty($v['status']) ? '<font class="text-success">启用</font>' : '<font class="text-danger">停用</font>'; ?></td>
                <td>
                  <a href="add?pid=<?php echo htmlentities((string) $v['id']); ?><?php echo !empty($pluginId) ? '&plugin='.$pluginId  :  ''; ?><?php echo !empty($iframe) ? '&iframe=1'  :  ''; ?>">添加子菜单</a>
                  <span class="text-muted mx-1">|</span>
                  <a href="edit?id=<?php echo htmlentities((string) $v['id']); ?><?php echo !empty($iframe) ? '&iframe=1'  :  ''; ?>">修改</a>
                  <span class="text-muted mx-1">|</span>
                  <a href="javascript:void(0)" class="text-danger" onclick="del(<?php echo htmlentities((string) $v['id']); ?>)">删除</a>
                </td>
              </tr>
                <?php endforeach; ?>
            </tbody>
