<?php /*a:2:{s:54:"/www/wwwroot/www.xvv.cc/app/admin/view/role/index.html";i:1773769974;s:48:"/www/wwwroot/www.xvv.cc/app/admin/view/base.html";i:1773769974;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-bordered">
            ...
            <tbody>
                <?php foreach($roles as $v): if($v['rules']!='*'): ?>
              <tr>
                <td><?php echo htmlentities((string) $v['id']); ?></td>
                <td><?php echo htmlentities((string) $v['name']); ?></td>
