<?php /*a:2:{s:55:"/www/wwwroot/www.xvv.cc/app/admin/view/admin/index.html";i:1773769974;s:48:"/www/wwwroot/www.xvv.cc/app/admin/view/base.html";i:1773769974;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    ...
    <div class="card">
      <div class="card-body">
        <div class="card-btns mb-2-5">
          <a class="btn btn-sm btn-primary me-1" href="add"><i class="mdi mdi-plus"></i> 新增</a>
        </div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo htmlentities((string) $v['username']); ?></td>
                <td><?php echo htmlentities((string) $v['nickname']); ?></td>
                ...
                <td><?php echo htmlentities((string) $v['update_time']); ?></td>
                <td>
                  <a href="edit?id=<?php echo htmlentities((string) $v['id']); ?>">修改</a>
