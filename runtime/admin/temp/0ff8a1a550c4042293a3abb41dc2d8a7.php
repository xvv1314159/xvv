<?php /*a:2:{s:62:"/www/wwwroot/www.xvv.cc/app/admin/view/config/group_index.html";i:1773769974;s:48:"/www/wwwroot/www.xvv.cc/app/admin/view/base.html";i:1773769974;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    ...
    <div class="card">
      <div class="card-body">
        <div class="card-btns mb-2-5">
          <a class="btn btn-sm btn-primary me-1" href="<?php echo url("config/group_add"); ?>"><i class="mdi mdi-plus"></i> 添加分组</a>
        </div>
        ...
        <div class="table-responsive">
          <table class="table table-bordered">
            <thead>
              <tr>
                <th width="80">ID</th>
                <th width="150">分组标识</th>
                <th width="150">分组标题</th>
                <th width="100">配置项数量</th>
                <th width="80">排序</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo htmlentities((string) $v['group_key']); ?></td>
                <td><?php echo htmlentities((string) $v['group_title']); ?></td>
                <td>
                  <a href="<?php echo url("config/config_manage"); ?>?group=<?php echo htmlentities((string) $v['group_key']); ?>" class="text-primary">
                    查看配置项
                  </a>
                </td>
                ...
                <td>
                  <a href="<?php echo url("config/group_edit"); ?>?id=<?php echo htmlentities((string) $v['id']); ?>">编辑</a>
                  <span class="text-muted mx-1">|</span>
                  <a href="<?php echo url("config/config_manage"); ?>?group=<?php echo htmlentities((string) $v['group_key']); ?>">配置项</a>
                  <span class="text-muted mx-1">|</span>
                  <a href="javascript:void(0)" class="text-danger" onclick="del(<?php echo htmlentities((string) $v['id']); ?>, <?php echo url("config/group_delete"); ?>)">删除</a>
                </td>
              </tr>
