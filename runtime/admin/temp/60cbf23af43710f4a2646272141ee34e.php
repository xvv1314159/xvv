<?php /*a:2:{s:57:"/www/wwwroot/www.xvv.cc/app/admin/view/log/login_log.html";i:1773769974;s:48:"/www/wwwroot/www.xvv.cc/app/admin/view/base.html";i:1773769974;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center">
    <h5 class="mb-0"><i class="mdi mdi-login me-1"></i> 登录日志</h5>
    <button class="btn btn-sm btn-outline-danger" onclick="clearLog()"><i class="mdi mdi-delete"></i> 清空日志</button>
  </div>
  <div class="card-body">
    <form class="row g-2 mb-3" method="get">
      <div class="col-auto">
        <input type="text" class="form-control form-control-sm" name="keyword" value="<?php echo htmlentities((string) $keyword); ?>" placeholder="搜索用户名">
      </div>
      <div class="col-auto">
        <select class="form-select form-select-sm" name="status">
          <option value="">全部状态</option>
          <option value="1" <?php if($status==='1'): ?>selected<?php endif; ?>>成功</option>
          <option value="0" <?php if($status==='0'): ?>selected<?php endif; ?>>失败</option>
        </select>
      </div>
      <div class="col-auto">
      ...
      <table class="table table-hover table-sm align-middle">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo htmlentities((string) $log['remark']); ?></td>
            <td style="max-width:200px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:11px;color:#999" title="<?php echo htmlentities((string) $log['ua']); ?>"><?php echo htmlentities((string) $log['ua']); ?></td>
            <td><?php echo htmlentities((string) date('Y-m-d H:i:s',!is_numeric($log['create_time'])? strtotime($log['create_time']) : $log['create_time'])); ?></td>
          </tr>
          <?php endforeach; ?>
        </tbody>
      </table>
...
function clearLog() {
  _vm.confirm('确定要清空所有登录日志吗？此操作不可撤销！', () => {
    _vm.post(<?php echo url("log/clear_login_log"); ?>, {}, res => {
